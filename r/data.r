...
work <- tribble(
    ...
    "Information Technology Associate", "California Correctional Health Care Services", "July", 2018, "September", 2018, "Elk Grove - California", "LANGUAGES USED --- SQL, CCL, VBA",
    "Information Technology Associate", "California Correctional Health Care Services", "July", 2018, "September", 2018, "Elk Grove - California", "Resolved user tickets for the CCHCS Department statewide for issues related to Devices Scheduling and Mental Health Provider builds, and support in relation to the Cerner Millennium Software for the CCHCS EHRS (Electronic Health Record System)",
    "Information Technology Associate", "California Correctional Health Care Services", "July", 2018, "September", 2018, "Elk Grove - California", "Used Database Administrator access to grant user permissions, build and route new resources, clinic lines, and locations within the Cerner Millennium medical software",
    "Information Technology Associate", "California Correctional Health Care Services", "July", 2018, "September", 2018, "Elk Grove - California", "Troubleshoot issues related to Cerner Millennium for end users and stake holders",
    "Health Program Specialist", "California Correctional Health Care Services", "June", 2018, "July", 2018, "Elk Grove - California", "LANGUAGES USED --- R, VBA, RMarkdown, HTML, CSS",
    "Health Program Specialist", "California Correctional Health Care Services", "June", 2018, "July", 2018, "Elk Grove - California", "Created a tool to simplify data set cleaning for most Quality Management SQL Server reports for front end staff that is utilized state wide",
    "Health Program Specialist", "California Correctional Health Care Services", "June", 2018, "July", 2018, "Elk Grove - California", "Conducted data literacy and anaylsis training to over 120+ department staff of all levels from Office Assistants to CEOs at 10 remote sites",
    "Health Program Specialist", "California Correctional Health Care Services", "June", 2018, "July", 2018, "Elk Grove - California", "Created automated reports with VBA programming in Excel using programming concepts such as arrays, loops, variables, objects, & API's",
    "Health Program Specialist", "California Correctional Health Care Services", "June", 2018, "July", 2018, "Elk Grove - California", "Region wide subject matter expert in Microsoft Excel",
