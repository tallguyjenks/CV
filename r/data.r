...
work <- tribble(
    ...
    "Associate Governmental Program Analyst --- California Correctional Health Care Services", "Region 1 Quality Management", "November", 2018, "October", 2019, "Elk Grove - California", "Created a report that processes over 50,000 medical records daily simplifying overdue ,medical appointments resolution state wide,",
    ...
    "Office Technician --- California Correctional Health Care Services", "Mule Creek State Prison", "April", 2016, "October", 2016, "Ione - California", "Analyzed Inmate Health Care Appeals independently,reviewed and recommended methods of processing while preparing,the appeals for review by the Appeal Coordinator",
    ...
    "Office Assistant --- California Correctional Health Care Services", "Mule Creek State Prison", "September", 2015, "March", 2016, "Ione - California", "Analyzed on average 14000+ medical,documents for completion of signatures of the various,stages of processing and routing and submission into the,Health Care Services eUHR Database every month.",
    "Office Assistant --- California Correctional Health Care Services", "Mule Creek State Prison", "September", 2015, "March", 2016, "Ione - California", "Documents handled such as but not limited to: Mental Health Treatment Plans Mental Health Notes 7230 Medical Progress Notes 7230 7362 Request for Medical Services Forms and Dental Chart update forms.",
