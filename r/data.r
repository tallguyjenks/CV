...
work <- tribble(
    ...
    "Research Data Specialist I (A)", "California Correctional Health Care Services", "October", 2020, "November", 2020, "Elk Grove - California", "LANGUAGES USED --- HTML, CSS, SASS, JavaScript, R, RMarkdown, SQL, CCL",
    "Research Data Specialist I (A)", "California Correctional Health Care Services", "October", 2020, "November", 2020, "Elk Grove - California", "Client side Cerner Millenium Database Administrator",
    "Research Data Specialist I (A)", "California Correctional Health Care Services", "October", 2020, "November", 2020, "Elk Grove - California", "I design and disseminate statistical reports and visualizations written with R and RMarkdown",
    "Research Data Specialist I (A)", "California Correctional Health Care Services", "October", 2020, "November", 2020, "Elk Grove - California", "I create SQL queries to extract raw data from an enterprise wide data warehouse",
    "Research Data Specialist I (A)", "California Correctional Health Care Services", "October", 2020, "November", 2020, "Elk Grove - California", "Using (HTML CSS/SASS JavaScript) as well as CCL/SQL,I draft stand alone webpages embedded in our Cerner Millenium medical software",
